...
var questions = [{
    ...
    "answer4": 'מוטיבציה, התמודדות עם היחסים, פו״ש, תכנון ודינמניות, בטיחות',
    "correctAnswer": "4"
}, {
...
function initGame(){
    ...
    for(var i = 1; i <= 10; i++){
        nRandomNumber = Math.floor(Math.random() * (28 - 0) + 0);
    ...
    instructions.innerHTML += "<div class='instructionsTitle'>הוראות</div><br>" + 
                                "<div class='instructionsBody'>השתמשו בחצים על גבי המסך כדי לזוז. <br> רדפו אחר כל השאלות וענו נכונה כדי לצבור נקודות! <br> כל נקודה רגילה על המסך מעניקה נקודה אחת וכל תשובה נכונה מעניקה 10 נקודות. <br> שחקו, למדו, תרגלו ותנהו!</div><br>" + 
